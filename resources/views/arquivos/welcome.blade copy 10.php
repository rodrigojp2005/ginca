...
<body>
    ...
    <script>
        ...
        // Função para posicionar o marcador no Street View
        // function positionMarkerInStreetView() {
        //     const markerElement = document.getElementById('street-view-marker');
        //      // Mostra o marcador apenas uma vez quando o Street View é carregado
        //     if (markerElement.style.display !== 'block') {
        //         markerElement.style.display = 'block';
                
        //         // Posiciona o marcador no centro da visualização inicial
        ...
        //     // Posiciona o marcador no centro da visualização
        //     //      markerElement.style.left = '50%';
        //     //      markerElement.style.top = '50%';
        //     // aumentar tamanho do marcador em porcentangem
        //     //      markerElement.style.width = '40px';
        //     //      markerElement.style.height = '60px';
        // }
        function positionMarkerInStreetView() {
            const markerElement = document.getElementById('street-view-marker');
            markerElement.style.display = 'none'; // Esconde o marcador HTML
            ...
            // Obtém a posição atual do panorama
            const panoramaPosition = panorama.getPosition();
            const pov = panorama.getPov(); // Precisa do POV para obter o heading

             // Verifica se temos os dados necessários
            if (!panoramaPosition || !pov) {
                console.error("Não foi possível obter a posição ou POV do panorama para o marcador.");
                return; // Sai se não tiver os dados
            }
                
            const heading = pov.heading;
            const distance = 15; // 15 metros

            // Calcula uma posição 15 metros à frente da câmera
                //const heading = panorama.getPov().heading;
                //const distance = 15; // 15 metros
                
                // Usa a geometria esférica para calcular o novo ponto
              ...
              // Cria um novo marcador usando a API do Street View NA POSIÇÃO CALCULADA
                window.streetViewMarker = new google.maps.Marker({
                    position: newPosition, // <<< USA A POSIÇÃO CALCULADA AQUI
                    map: panorama,
                    icon: {
                        ...
                        scaledSize: new google.maps.Size(80, 120), // Ajuste tamanho conforme necessário
                        anchor: new google.maps.Point(40, 120) // Âncora na base central do GIF
                    },
                    title: "Ponto de Interesse" // Opcional: adiciona um título
                });

            // Cria um novo marcador usando a API do Street View
            // window.streetViewMarker = new google.maps.Marker({
        ...
        async function newRound() {
            ...
            // Adiciona listener para quando o Street View estiver carregado
